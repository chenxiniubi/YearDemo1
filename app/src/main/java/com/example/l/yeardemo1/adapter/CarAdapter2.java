...
import com.example.l.yeardemo1.bean.Goods;
import com.example.l.yeardemo1.bean.Shop;
import com.example.l.yeardemo1.view.AddSubLayout;
...
public class CarAdapter2 extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        holder.checkBox.setChecked(shop.isCheck());//设置商铺选中状态holder.checkBox.setChecked(shop.isCheck());//设置商铺选中状态
